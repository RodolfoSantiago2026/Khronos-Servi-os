...
function DashboardContent() {
  ...
  // Cálculos KPI (Ignorando 'Perdido')
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">SLA, Histórico e Funil de Vendas.</p>
        </div>
      ...
      {/* KPI Cards */}
      {(activeTab === 'dashboard' || activeTab === 'relatorios') && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-md border border-slate-200 border-t-4 border-t-slate-400 shadow-sm">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Total Ativos</h3>
            <p className="text-2xl font-black text-slate-900">{activeLeads.length}</p>
          </div>
          <div className="bg-white p-5 rounded-md border border-slate-200 border-t-4 border-t-brand-orange shadow-sm">
          ...
          <div className="bg-white p-5 rounded-md border border-slate-200 border-t-4 border-t-blue-500 shadow-sm">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Pipeline (Estimado)</h3>
            <p className="text-2xl font-black text-blue-500">
              R$ {totalValue.toLocaleString('pt-BR')}
            </p>
          </div>
          <div className="bg-white p-5 rounded-md border border-slate-200 border-t-4 border-t-brand-emerald shadow-sm">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Fechado (Real)</h3>
      ...
      {/* Relatórios Placeholder (Apenas visualização extra se relatórios estiver ativo) */}
